export default class Settings {
    ...
    constructor() {
        ...
        //Api keys for the online maps, and image for the offline maps
        this.map = {
            'urls': {
        ...
        //Image of no camera
        //Because we couldn't use it as an external image, we had to transform the image to bytes
    ...
    //This would change when we have a real sensor
    ...
    //Process all the information of the GPS
    processGPSData(gps) {
        if (gps != undefined) {
    ...
    //If we do not recieve information, the webpage would show #### as a base
    //At the moment that we recieve some information the variable would change to the real number
    ...
    updateAnalytics() {
        ...
        //Update the image of the conection status
    ...
    //Update the image of the battery status
    updateBatteryStatus() {
    ...
    //Transform the no camera image from bytes to an actual image
