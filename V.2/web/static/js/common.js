export function updateVelocity(vx, vy, vz) {
...
export function updateGeoloctaion(lat, lon, alt) {
...
export function updateTime(date, time) {
...
export function updateBatteryStatus(percentage, isConnected) {
